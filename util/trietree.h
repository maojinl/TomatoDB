...
class TrieTree {
 ...
 public:
  ...
  bool IsEmpty() { return edgesCount == 0 && links.size() == 0; }

  bool IsRoot() { return parent == nullptr; }

  LinksIterator LinksBegin() { return links.begin(); }

  LinksIterator LinksEnd() { return links.end(); }
